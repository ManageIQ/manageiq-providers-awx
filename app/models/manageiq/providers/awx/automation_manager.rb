class ManageIQ::Providers::Awx::AutomationManager < ManageIQ::Providers::ExternalAutomationManager
  include ProcessTasksMixin

  class << self
    delegate :params_for_create,
             :verify_credentials,
             :to => ManageIQ::Providers::Awx::Provider
  end
  ...
  def self.ems_type
    @ems_type ||= "awx_automation".freeze
  end

  def self.description
    @description ||= "AWX".freeze
  end

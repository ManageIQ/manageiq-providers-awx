describe ManageIQ::Providers::Awx::AutomationManager::ConfigurationScript do
  ...
  describe '#run_with_miq_job' do
    it 'delegates request to template runner' do
      ...
      expect(ManageIQ::Providers::Awx::AutomationManager::TemplateRunner)
  ...
  context "awx configuration_script" do
    let(:provider_with_authentication) { FactoryBot.create(:provider_awx, :with_authentication) }
    let(:manager_with_authentication)  { provider_with_authentication.automation_manager }

    let(:manager_with_configuration_scripts) do
      FactoryBot.create(:automation_manager_awx, :configuration_script, :provider => provider_with_authentication)
    end

    # subject { FactoryBot.create(:awx_configuration_script, :manager => manager_with_configuration_scripts) }
    ...
    context "#run" do
      ...
      it "launches the referenced awx job template" do

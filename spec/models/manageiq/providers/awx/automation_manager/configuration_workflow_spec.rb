...
describe ManageIQ::Providers::Awx::AutomationManager::ConfigurationWorkflow do
  ...
  let(:manager)               { FactoryBot.create(:automation_manager_awx, :configuration_workflow, :provider => provider_with_authentication) }
  context "#run" do
    before do
    ...
    it "launches the referenced awx workflow job template" do

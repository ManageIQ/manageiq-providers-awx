...
describe ManageIQ::Providers::Awx::AutomationManager::WorkflowJob do
  ...
  subject { FactoryBot.create(:awx_workflow_job, :workflow_template => workflow_template, :ext_management_system => manager) }

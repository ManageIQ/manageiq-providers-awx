describe ManageIQ::Providers::Awx::AutomationManager::Refresher do
  ...
  # 2. rake manageiq:providers:awx:populate_tower
  ...
  # ruby -pi -e 'gsub /yourdomain.com/, "example.com"; gsub /admin:smartvm/, "testuser:secret"' spec/vcr_cassettes/manageiq/providers/awx/automation_manager/*.yml
  ...
  it "limits the size of configuration_script_source.last_update_error" do
    stub_const("#{ManageIQ::Providers::Awx::Inventory::Parser::AutomationManager}::ERROR_MAX_SIZE", 20)

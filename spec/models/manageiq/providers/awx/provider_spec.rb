...
describe ManageIQ::Providers::Awx::Provider do
  subject { FactoryBot.create(:provider_awx) }
  describe ".raw_connect" do
    ...
    it "with no port" do
      ...
      described_class.raw_connect(url, "admin", "smartvm", OpenSSL::SSL::VERIFY_PEER)
    end

    it "with a port" do
      url = "http://example.com:555"
      expected_url = "http://example.com:555/api/v2"
    ...
    it "with an explicit api path" do
      ...
      expected_url = "http://example.com/api/v1"
